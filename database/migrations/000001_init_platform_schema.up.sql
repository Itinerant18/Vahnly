...
ALTER TABLE regional_cities ADD COLUMN IF NOT EXISTS timezone VARCHAR(50) DEFAULT 'Asia/Kolkata' NOT NULL;
...
ALTER TABLE drivers ADD COLUMN IF NOT EXISTS name VARCHAR(100) DEFAULT 'Unknown' NOT NULL;
...
ALTER TABLE drivers ADD COLUMN IF NOT EXISTS is_verified BOOLEAN DEFAULT false NOT NULL;
ALTER TABLE drivers ADD COLUMN IF NOT EXISTS cancellation_rate NUMERIC(4,3) DEFAULT 0.000 NOT NULL;
ALTER TABLE drivers ADD COLUMN IF NOT EXISTS cancellation_probability NUMERIC(4,3) DEFAULT 0.000 NOT NULL;
ALTER TABLE drivers ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL;

-- Ensure constraints and defaults on pre-existing drivers table are updated for migration inserts
ALTER TABLE drivers ALTER COLUMN name SET DEFAULT 'Unknown';
ALTER TABLE drivers ALTER COLUMN phone DROP NOT NULL;
ALTER TABLE drivers ALTER COLUMN dl_number DROP NOT NULL;
...
ALTER TABLE orders ADD COLUMN IF NOT EXISTS customer_id UUID DEFAULT gen_random_uuid() NOT NULL;
ALTER TABLE orders ADD COLUMN IF NOT EXISTS pickup_osm_node_id BIGINT;
ALTER TABLE orders ADD COLUMN IF NOT EXISTS surge_multiplier NUMERIC(3,2) DEFAULT 1.00 NOT NULL;
...
ALTER TABLE dispatch_match_logs ADD COLUMN IF NOT EXISTS executed_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL;
ALTER TABLE dispatch_match_logs ADD COLUMN IF NOT EXISTS created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL;
